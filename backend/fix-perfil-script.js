...
const allTechs = ["Java", "Python", "JavaScript", "TypeScript", "C++", "C#", "Go", "PHP", "Swift", "Kotlin", "Ruby", "HTML", "CSS", "React", "Angular", "Vue.js", "Node.js", "Spring Boot", "Django", "FastAPI", "Laravel", "SQL", "MySQL", "PostgreSQL", "MongoDB", "Redis", "Docker", "Kubernetes", "AWS", "Azure", "GCP", "Git"];
  ...
  const hasNewTech = newTechsOnly.length > 0;
    ...
    if (window.DevMatchApi.enabled) {
      if (hasNewTech) {
        ...
        const respuesta = await fetch(\`http://3.230.17.89/api/users/\${idUsuario}/stack-test\`, {
            method: 'POST',
...
loadProfile();
\`;
fs.writeFileSync('c:/Users/eduar/OneDrive/Desktop/devmatch-backend/fix-perfil.js', content);
console.log('Done');
